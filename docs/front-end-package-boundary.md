...
nothing; amendment #3 DOES re-measure, at the six trees its own block below
names and on its own dates, 2026-09-13 and 2026-09-14. Every figure it adds
carries the tree it was read at, so the two sets never have to be told apart
by their dates)*:
...
**Every figure amendment #3 states NAMES THE TREE it was read at, and names
