This is the **spec leg** of openDox (`opendox`): requirements, decisions
...
`opensoft/openDox-code`, beside it at `../code/`, once the root is cloned with
`--recurse-submodules`.
...
`opensoft/openDox` moving the gitlink, `contracts/spec-pin.yaml` and every
